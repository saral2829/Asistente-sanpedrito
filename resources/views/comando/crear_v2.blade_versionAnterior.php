    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action={{route('comando.update_v2')}} method="POST" autocomplete="off" class="form_horizontal" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <select class="form-control @error('comando_padre')
                                        ...
                                        <option value="no_select" @if(old('comando_padre')=='no_select' ) selected @endif>Sin padre</option>
