    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action={{route('comando.update_v2', $comando)}} method="POST" autocomplete="off" class="form_horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    ...
                                    <input type="text" value="{{ old('nombre_comando',substr($comando->nombre, 1)) }}" class="form-control @error('nombre_comando') is-invalid  @enderror " id="nombre_comando" name="nombre_comando" aria-describedby="basic-addon1" placeholder="Ejemplo: /bot">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <input placeholder="Breve descripción del comando" type="text" value="{{ old('descripcion',$comando->descripcion) }}" name="descripcion" class="form-control @error('descripcion')
                                            is-invalid
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <select disabled class="form-control @error('tipo_comando')
                                            is-invalid
                                        @enderror" name="tipo_comando" id="tipo_comando">
                                        <option value="NORMAL" @if(old('tipo_comando',$comando->tipo_comando)=='NORMAL' ) selected @endif>Normal</option>
                                        <option value="GRUPAL" @if(old('tipo_comando',$comando->tipo_comando)=='GRUPAL' ) selected @endif>Grupal</option>
                                        <option class="d-none" value="SUBCOMANDO" @if(old('tipo_comando')=='SUBCOMANDO' ) selected @endif>Subcomando</option>
                                    </select>
                                    @error('tipo_comando')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <select @if($comando->tipo_comando == 'GRUPAL') disabled @endif class="form-control @error('tipo_respuesta')
                                            is-invalid
                                        @enderror" name="tipo_respuesta" id="tipo_respuesta">
                                        <option value="NORMAL" @if($comando->tipo_respuesta =="NORMAL" ) selected @endif>Normal</option>
                                        <option value="ARCHIVO" @if($comando->tipo_respuesta =="ARCHIVO" ) selected @endif>Archivo</option>
                                    </select>
                        ...
                        <div class="row mb-3 @if($comando->tipo_respuesta =="NORMAL" ) d-none @endif" id="div_archivo">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <textarea class="form-control" style="" @if($comando->tipo_comando == 'GRUPAL') disabled @endif name="respuesta" id="respuesta" placeholder="Instrucciones o respuesta que mostrará PedritoBot...">{{ old('respuesta',$comando->respuesta)  }} </textarea>
                        ...
                        <div class="row mb-3" id="div_comandos_padre">
                            ...
                            <div class="col-sm-10">
                                <div class="form-group bmd-form-group">
                                    <select class="form-control @error('comando_padre')
                                        ...
                                        @foreach($comandos_padre as $comand)
                                            @if($comando->id != $comand->id  && $comand->comando_padre != $comando->id)
                                                <option value="{{$comand->id}}" @if($comando->comando_padre == $comand->id ) selected @endif>{{$comand->nombre}}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                    @error('comando_padre')
                        ...
                        <div class="card-footer ml-auto mr-auto">
                            <button type="submit" class="btn btn-info">Modificar<div class="ripple-container"></div></button>
                        </div>
                    </form>
                </div>
            </div>
